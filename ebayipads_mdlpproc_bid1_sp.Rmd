...
title: "eBay:iPads:: startprice.log10 regression:: mdlpproc_bid1_sp"
author: "bdanalytics"
...
### bid1_sp
    ...
    #RFE.X.bagEarth degree=1 [2]; nprune=16 32 64 128 [256]; RMSE=0.6310819
    #RFE.X.bagEarth degree=1 [2]; nprune=64 128 200 225 [256]; RMSE=0.6320776
...
glb_tune_models_df <- myrbind_df(glb_tune_models_df, rbind(data.frame()
    ,data.frame(method = "bagEarth", parameter = "nprune", vals = "64 128 200 225 256")
    ,data.frame(method = "bagEarth", parameter = "degree", vals = "1 2")    
))
### bid0&1_sp
...
glb_tune_models_df <- myrbind_df(glb_tune_models_df, rbind(data.frame()
    ,data.frame(method = "gbm", parameter="shrinkage", min=0.03, max=0.07, by=0.01)
    ,data.frame(method = "gbm", parameter="n.trees", min=100, max=300, by=50)
    ,data.frame(method = "gbm", parameter="interaction.depth", min = 3, max = 7, by = 1)
    ,data.frame(method = "gbm", parameter = "n.minobsinnode", min = 6, max = 14, by = 2)
